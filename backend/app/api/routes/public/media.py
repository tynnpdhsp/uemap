...
from app.services import media_service, session_service
...
async def get_media(
    object_key: str, current_student: Optional[dict] = Depends(get_optional_student)
):
    ...
    return StreamingResponse(
        stream, media_type=mime_type, headers={"Cache-Control": "max-age=86400, public"}
    )
